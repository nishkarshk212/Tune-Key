  ...
  const plans = [
    {
      ...
      rps_limit: 5,
      max_keys: 1,
      features: JSON.stringify(['500 Requests / day', '1 Dedicated API Key', 'Community Support', '98% Uptime']),
      is_popular: 0,
      is_active: 1
    },
    {
      ...
      rps_limit: 10,
      max_keys: 1,
      features: JSON.stringify(['1,000 Requests / day', '1 Dedicated API Key', 'Standard Support', '99% Uptime']),
      is_popular: 0,
      is_active: 1
    },
    {
      ...
      rps_limit: 20,
      max_keys: 1,
      features: JSON.stringify(['1,500 Requests / day', '1 Dedicated API Key', 'Priority Support', '99.9% Uptime']),
      is_popular: 1,
      is_active: 1
    },
    {
      ...
      rps_limit: 30,
      max_keys: 1,
      features: JSON.stringify(['2,000 Requests / day', '1 Dedicated API Key', 'Priority Support', '99.9% Uptime']),
      is_popular: 0,
      is_active: 1
    },
    {
      ...
      rps_limit: 50,
      max_keys: 1,
      features: JSON.stringify(['2,500 Requests / day', '1 Dedicated API Key', 'VIP Support', '99.9% Uptime']),
      is_popular: 0,
      is_active: 1
    }
  ];
